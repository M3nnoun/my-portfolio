          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I love participating in hackathons where I get to use AI and
                  data science to build exciting, collaborative projects. During
                  university, these events opened my eyes to the power of
                  innovation when passionate people come together to create
                  something impactful in just a few days.
                </p>
              </div>
            </div>
          </BlurFade>
